...
export const PickCard: React.FC<{
  ...
  return (
    <div className="flex flex-col items-center w-max gap-4 lg:flex-col-reverse lg:gap-[3.9375rem]">
      <div
        className={`relative w-[8.125rem] h-[8.125rem] grid place-items-center lg:w-[18.25rem] lg:h-[18.75rem] ${
          winner ? "bg-winner" : ""
        }`}
      >
        {type ? (
      ...
      <p className="text-white font-bold tracking-widest [font-size:0.9375rem] lg:[font-size:1.5rem]">
        {text}
      </p>
    </div>
  );
