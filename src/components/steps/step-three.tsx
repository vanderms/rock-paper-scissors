    ...
    <div className="mt-24 w-full flex flex-wrap justify-between gap-y-[3.875rem] lg:flex-nowrap lg:w-[58.6875rem] mx-auto lg:items-center lg:gap-16">
      <div className={`flex lg:order-1`}>
        <PickCard
          type={props.userPick}
          text="YOU PICKED"
          winner={props.result === GameResult.WIN}
        />
      </div>
      <div className={`flex lg:order-3 `}>
        <PickCard
          type={props.housePick}
          text="THE HOUSE PICKED"
          winner={props.result === GameResult.LOSS}
        />
      </div>

      <div className=" w-full flex flex-col gap-4 col-span-2 items-center lg:order-2 relative z-50">
